...
@click.option('-a', '--authaddress',default=0,help='choose the authaddress')
def parse_command(quality, mode, path, thread, verbose,authaddress, url):
    """
